...
## Resume-safe claims
You can honestly claim that you:
- built a modular risk scoring system for imbalanced tabular fraud detection,
- implemented leakage-aware preprocessing and reproducible train/infer pipelines,
- compared baseline and stronger models with calibration-aware selection,
- implemented threshold regimes including cost-sensitive decision mode,
- delivered typed FastAPI scoring endpoints and a decision-focused Streamlit UI,
- documented caveats and model-selection outcomes transparently.
